...
class StabilityTests(unittest.TestCase):
    ...
    def test_webui_task_panel_keeps_finished_summary(self):
        ...
        self.assertIn('id="taskStatusDock"', html)
        self.assertIn("task-status-dock-visible", html)
        self.assertIn("function renderTaskStatusDock", html)
        self.assertIn("renderTaskStatusDock(summary)", html)
